...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            var fxaaActive = this.m_Fxaa.active;
            var taaActive = this.m_Taa.active && !this.m_RenderingInSceneView;
            var dofActive = this.m_DepthOfField.active && !this.m_RenderingInSceneView;
        ...
        void CheckObservers()
        {
            ...
            for (var i = 0; i < this.m_ComponentsToDisable.Count; i++)
            {
            ...
            for (var i = 0; i < this.m_ComponentsToEnable.Count; i++)
            {
